<template>
 <v-footer class="footer" ref="footer">
    <v-container style="text-align: center">
      <v-row class="footer-container">
  <v-col cols="12" sm="6" md="2" class="footer-col wow fadeInUp" data-wow-duration="0.2s" data-wow-delay="0.2s">
    <div class="footer-box">
      <v-img src="/public/img/tran_logo.png" alt="Logo"></v-img>
    </div>
  </v-col>
  <v-col cols="12" sm="6" md="2" class="footer-col wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
    <div class="footer-box">
  ...
  <v-col cols="12" sm="6" md="2" class="footer-col wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.6s">
    <div class="footer-box">
  ...
  <v-col cols="12" sm="6" md="2" class="footer-col wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.6s">
    <div class="footer-box">
  ...
  <v-col cols="12" sm="6" md="2" class="footer-col wow fadeInUp" data-wow-duration="0.2s" data-wow-delay="0.2s">
    <div class="footer-box">
      <v-img src="/public/img/Visa_Brandmark_White_RGB_2021.png" alt="Logo"></v-img>
      <v-img src="/public/img/mc.png" alt="Logo"></v-img>
    </div>
  </v-col>
</v-row>
            ...
            <div class="content">
              <p class="text">
                ...
                <span class="companyAddress"
                  >27 Old Gloucester Street, London, UK, 3AX UK</span
                >
              </p>
            </div>
          </div>
          ...
          <div class="footer-bottom margin-none" style="margin-top: -3%;">
            <div class="content">
              <p class="text">
                ...
                jeopardizing one's financial security or lifestyle. Only risk
                ...
                completely account for the impact of financial risk on actual
                trading. For example, the ability to withstand losses or to
                adhere to a particular trading program in spite of trading
                losses is a material point which can also adversely affect
...
export default {
  mounted() {
    // No need for scroll event listener
  },
  beforeDestroy() {
...
.footer .footer-box:last-child {
  margin: 0; /* Remove margins for the first and last footer boxes */
}
...
.footer .footer-bottom.margin-none {
  margin-top: 0;
}
